    ...
    <div className={s['manual-wrap']}>
      ...
      <article className={s['manual']}>
        ...
        <nav className={s['manual-toc']}>
          <h2>สารบัญ</h2>
          <ol>
            <li><a href="#s1">เข้าสู่ระบบแอดมิน</a></li>
            <li><a href="#s2">เตรียมข้อมูลทดสอบด้วยปุ่มเดียว (เว็บทดสอบเท่านั้น)</a></li>
            <li><a href="#s3">เติมสต๊อกโค้ด (จัดการสต๊อก)</a></li>
            <li><a href="#s4">เพิ่มเครดิตให้ลูกค้า</a></li>
            <li><a href="#s5">โค้ดถึงมือลูกค้าได้ 3 ทาง</a></li>
            <li><a href="#s6">ยืนยันสลิปแมนนวล (คำสั่งซื้อ)</a></li>
            <li><a href="#s7">เครดิตไม่พอเกิดอะไรขึ้น</a></li>
            <li><a href="#s8">เคล็ดลับการใช้งานจริง</a></li>
            <li><a href="#s9">แบบทดสอบ A–E (ตรวจสอบว่าระบบปกติ)</a></li>
            <li><a href="#s10">ติดต่อ/แก้ปัญหา</a></li>
          </ol>
        </nav>

        <Section id="s1" title="1. เข้าสู่ระบบแอดมิน">
          <ol>
            <li>เปิดหน้า <strong>/management/login</strong></li>
            <li>กรอก <strong>อีเมล + รหัสผ่าน</strong></li>
            <li>
              กด <strong>เข้าสู่ระบบ</strong> → ระบบจะถาม <strong>รหัส 6 หลัก</strong> จากแอป
              Authenticator (Google Authenticator / Authy)
            </li>
            <li>
              เปิดแอป Authenticator → ดูโค้ด 6 หลักของ &quot;Nong-Kati Admin&quot; → พิมพ์ลงช่อง → กด{' '}
          ...
          <table>
            ...
            <tbody>
              <tr>
                <td><code>admin@nong-kati.co.th</code></td>
                <td>ผู้ดูแลสูงสุด</td>
                <td>ทุกอย่าง</td>
              </tr>
              <tr>
                <td><code>catalogue@nong-kati.co.th</code></td>
                <td>ผู้จัดการสินค้า</td>
                <td>สินค้า/หมวดหมู่/คลัง (เปลี่ยนรหัสผ่านครั้งแรก)</td>
              </tr>
              <tr>
                <td><code>orders@nong-kati.co.th</code></td>
          ...
          <div className={s['callout']}>
            ...
            <p>
              ติ๊ก <strong>&quot;จดจำการเข้าสู่ระบบไว้ในเครื่องนี้ (30 วัน)&quot;</strong> เพื่อไม่ต้องยืนยัน
              2FA บ่อย (เครื่องส่วนตัวเท่านั้น)
            </p>
          </div>
        ...
        <Section id="s2" title="2. เตรียมข้อมูลทดสอบด้วยปุ่มเดียว (เว็บทดสอบเท่านั้น)">
          ...
          <ol>
            <li>ตั้งรหัสผ่านให้ลูกค้าทดสอบ (แจ้งโปรแกรมเมอร์ หรือสมัครบัญชีใหม่แล้วปรับเครดิตเองแทน)</li>
        ...
        <Section id="s3" title="3. เติมสต๊อกโค้ด (จัดการสต๊อก)">
          ...
          <ol>
            <li>
              <strong>สินค้า</strong> → หาแถวสินค้า → กดปุ่ม <strong>จัดการสต๊อก</strong> (ไอคอนรูปกุญแจ)
              <br />
              ใช้ได้ที่หน้า <strong>คลังสินค้า</strong> เช่นกัน (ช่องค้นหาพิมพ์ชื่อสินค้าหรือ Type ID ได้)
            </li>
            <li>
              ...
              <ul>
                ...
                <li>
                  <strong>แบบยาว (ข้อมูลหลายบรรทัด)</strong> — บัญชีที่มีข้อความยาว/อีโมจิ เช่น บล็อก HBO
                  <ul>
                    <li>
                      <strong>บรรทัดว่าง 2 บรรทัดติดกัน = แยกบัญชี</strong> (บรรทัดว่าง 1 บรรทัดภายในบล็อกเดียวกันจะถูกเก็บไว้)
                    </li>
            ...
            <li>วางข้อมูลลงช่องใหญ่ → กด <strong>แยกข้อมูล</strong></li>
            <li>
              ตรวจตัวอย่าง <strong>ไอดี #1, #2, …</strong> ให้ตรงกับจำนวนที่ต้องการ
              (&quot;จำนวนไอดีที่จะสร้าง: N&quot;)
            </li>
            <li>กด <strong>บันทึก</strong> — จบ</li>
          </ol>
          ...
          <ul>
            ...
            <li>
              จำนวน <strong>สต๊อก +N</strong> ทันที และบันทึกประวัติ <strong>StockMove (restock)</strong>
            </li>
            <li>
          ...
          <div className={s['callout']}>
            <p>
              💡 <strong>แบ่งโค้ดหลายสินค้า:</strong> สินค้าที่มีหลายแพ็กเกจ ระบบจะแจกโค้ดเข้าแพ็กเกจแบบวนรอบ
              ใช้บรรทัดขึ้นต้นด้วย <code>Label:</code> เพื่อระบุแพ็กเกจเฉพาะได้
            </p>
          </div>
        </Section>
        ...
        <Section id="s4" title="4. เพิ่มเครดิตให้ลูกค้า">
          ...
          <p>
            ...
            &quot;แอดมินปรับเครดิต&quot;) ลูกค้าเห็นยอดทันทีที่หน้า <strong>บัญชี → กระเป๋าเงิน</strong>
          </p>
          <div className={`${s['callout']} ${s['warn']}`}>
            <p>
        ...
        <Section id="s5" title="5. โค้ดถึงมือลูกค้าได้ 3 ทาง">
          <ol>
            <li>
              <strong>เครดิต (ทันทีที่สุด):</strong> ลูกค้าเลือก &quot;เครดิตในกระเป๋า&quot; ตอนชำระเงิน →
              ระบบหักเงิน + ส่งโค้ดในหน้าเดียวจบ
            </li>
            <li>
              <strong>PromptPay (อัตโนมัติ):</strong> ลูกค้าสแกน QR → ธนาคารแจ้งระบบอัตโนมัติ → โค้ดถูกส่งภายในไม่กี่วินาที
              (แอดมินไม่ต้องทำอะไร)
            </li>
            <li>
          ...
          <div className={s['callout']}>
            <p>
              💡 หากลูกค้าบอกว่า &quot;ยังไม่ได้รับโค้ด&quot; → ให้ดูสถานะออเดอร์ที่หัวข้อ 6 ก่อนเสมอ
            </p>
          </div>
        </Section>
        ...
        <Section id="s6" title="6. ยืนยันสลิปแมนนวล (คำสั่งซื้อ)">
          <p>
            ใช้เมื่อลูกค้า <strong>โอนเงินแล้วแต่ระบบยังไม่จับได้</strong> (โอนผ่านธนาคารที่ไม่แจ้งระบบทันที /
            ส่งสลิปมาใน LINE)
          </p>
          <ol>
            <li>
              <strong>คำสั่งซื้อ</strong> → หาออเดอร์สถานะ <strong>รอชำระเงิน</strong> (ตรวจสลิปกับยอดและเวลา)
            </li>
            <li>
              กด <strong>ยืนยันการชำระเงิน</strong> หนึ่งครั้ง — ระบบจะ:
              <ul>
                <li>เปลี่ยนสถานะเป็น <strong>สำเร็จ</strong></li>
                <li>
            ...
            <li>
              ถ้าขึ้น <strong>รอจัดส่งด้วยตนเอง</strong> = โค้ดไม่พอตอนนั้น → เติมโค้ดก่อน (หัวข้อ 3) →
              กลับมากดยืนยัน/ลองใหม่ → ระบบส่งให้เอง
            </li>
          </ol>
          <div className={s['callout']}>
            <p>
              🔒 กดซ้ำไม่ได้ — ออเดอร์จ่ายแล้วจะถูกล็อก ไม่มีทางส่งโค้ดซ้ำ ทุกการยืนยันถูกบันทึกว่าใครกดเมื่อไร
            </p>
          </div>
        </Section>
        ...
        <Section id="s7" title="7. เครดิตไม่พอเกิดอะไรขึ้น">
          ...
          <table>
            ...
            <tbody>
              ...
              <tr>
                ...
                <td>
                  &quot;ระบบเครดิตขัดข้องชั่วคราว&quot; → <strong>เด้งไป QR PromptPay ให้เอง</strong>
                </td>
          ...
          <p className={s['emph']}>
            <strong>ไม่มีทางเกิด &quot;เงินถูกหักแต่ไม่ได้โค้ด&quot;</strong> — ระบบหักเงิน+ส่งโค้ดเป็นชุดเดียว
            ถ้าขั้นไหนล้มเหลวทุกอย่างย้อนกลับอัตโนมัติ
          </p>
        </Section>
        ...
        <Section id="s8" title="8. เคล็ดลับการใช้งานจริง">
          <h3>การเติมสต๊อก</h3>
          <ul>
            <li>เติมโค้ดก่อนโฆษณาสินค้าเสมอ — สินค้าที่สต๊อก 0 ขึ้น &quot;หมด&quot; และปิดปุ่มซื้อทันที</li>
            <li>คัดลอกจากไฟล์ Excel/Notion วางตรง ๆ ได้ ไม่ต้องแก้รูปแบบ</li>
            <li>สต๊อกใกล้หมด → ระบบแจ้งเตือนใน <strong>Discord</strong> ตั้งค่าได้ที่ <strong>ตั้งค่า</strong></li>
          </ul>
          ...
          <ul>
            <li>
              <strong>ประวัติเติมเงิน</strong> — เงินเข้าทุกช่องทาง (แยก &quot;แอดมินเพิ่มเครดิต&quot; /
              &quot;พร้อมเพย์&quot; / &quot;ใช้เครดิตซื้อสินค้า&quot;)
            </li>
            <li>
              <strong>รายงานรายได้</strong> — กำไรจริง (ราคาขาย − ต้นทุน) ตามช่วงเวลา
            </li>
            <li>
              <strong>รายงานสต๊อก</strong> — ขายดี / สินค้าค้างสต๊อก (ตั้ง &quot;ไม่ขาย N วัน&quot; ได้)
            </li>
            <li>
              <strong>คลังสินค้า</strong> — โค้ดพร้อมขายจริงต่อสินค้า (คอลัมน์ &quot;จำนวนบัญชี&quot;)
            </li>
          </ul>
          ...
          <ul>
            ...
            <li>
              พนักงานใหม่ → สร้างที่ <strong>เจ้าหน้าที่</strong> และเลือกสิทธิ์ให้น้อยที่สุดที่จำเป็น
            </li>
            <li>
        ...
        <Section id="s9" title="9. แบบทดสอบ A–E (ตรวจสอบว่าระบบปกติ)">
          <p>
            ใช้เวลาประมาณ 10 นาที ทดสอบครบทั้งระบบ (บนเว็บทดสอบ ใช้ dev-seed จากหัวข้อ 2 ก่อน):
          </p>
          <table className={s['test-table']}>
            ...
            <tbody>
              ...
              <tr>
                ...
                <td>
                  หน้ายืนยันมีโค้ด / โค้ดของฉัน มีโค้ด / กระเป๋าเงินหักถูกต้อง / ออเดอร์ &quot;สำเร็จ&quot;
                </td>
              </tr>
              <tr>
                <td className={s['col-check']}>{CHECK}</td>
          ...
          <table>
            ...
            <tbody>
              <tr>
                ...
                <td>
                  ดู <strong>คำสั่งซื้อ</strong> — ถ้า &quot;รอชำระเงิน&quot; = รอแจ้งธนาคาร กดยืนยันเอง
                  (หัวข้อ 6) · ถ้า &quot;รอจัดส่ง&quot; = เติมโค้ดแล้วกดลองใหม่
                </td>
              </tr>
              <tr>
                <td>โค้ดซ้ำ/โค้ดไม่ถูกต้อง</td>
                <td>
                  ค้นหาที่ <strong>คลังสินค้า</strong> → จัดการสต๊อก → ตรวจรายการ; ออเดอร์เก่าคืนเครดิตลูกค้าได้
                  (หัวข้อ 4)
                </td>
              </tr>
              <tr>
              ...
              <tr>
                ...
                <td>
                  ใช้ backup code ที่เก็บไว้ตอนเปิด 2FA หรือให้ผู้ดูแลสูงสุดรีเซ็ต
                </td>
              </tr>
              <tr>
