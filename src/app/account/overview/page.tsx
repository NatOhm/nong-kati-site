/**
 * Profile Overview (ภาพรวม) — wallet stats + top-up history. Extracted from
 * the old dashboard page so the profile page can own the tabbed product
 * views; linked from the profile header.
 */
