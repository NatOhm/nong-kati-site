...
export function CopyButton({
  ...
  return (
    <button
      onClick={handleCopy}
      className={cn(
        'inline-flex items-center whitespace-nowrap rounded-md border border-line bg-surface font-medium text-fg-secondary transition-all hover:border-line-brand hover:text-fg',
