...
## สรุป (อัปเดต 23 ก.ย. 2569)

- **✅ 35 ข้อ** · **🟡 1 ข้อ** (เปลี่ยนรูปมาสคอต/ไอคอนหนู — ส่งไฟล์มาได้เลย) · **⬜ 1 ข้อ** (ตรวจสลิปอัตโนมัติ — รอการตัดสินใจ มีแผนพร้อม)
- ยกเป็น ✅ แล้ว 2 ข้อจากรอบก่อน: **ยอดซื้อรายคน (A12)** และ **สินค้าค้างสต๊อก (A15)** — เสร็จตาม spec ที่ยืนยันกับลูกค้าแล้ว
- **เพิ่มใหม่ในสัปดาห์นี้ (ไม่ได้อยู่ในลิสต์เดิม แต่ทำเสริม):** ล็อกอินลูกค้าด้วย **Google/LINE** ได้ (ปุ่มจะโผล่เมื่อใส่คีย์ OAuth), จ่ายด้วย **เครดิตวอลเล็ต** ในเว็บ, ปุ่ม **กลับหน้าแรก** ทั้งโปรไฟล์ลูกค้าและแอดมิน, ปุ่ม 👁️ ดูรหัสผ่านหน้าแอดมิน
- ⬜ ตรวจสลิป: ตัดสินใจ SlipOK (แนะนำ ฿350/เดือน) vs PromptPay gateway (1.65%/รายการ) — ตารางเทียบที่ `docs/payment-verification-plan.md`
